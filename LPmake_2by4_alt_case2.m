function [ p_shapes, d, r_shape, p_num ] = LPmake_2by4_alt_case2 ( )

%*****************************************************************************80
%
%% lpmake_2by4_alt_case2() sets up case 2 of a 2x4 pariomino tiling problem.
%
%  Discussion:
%
...
%
  filename = '2by4_alt_case2.lp';
  label = '\ LP file for the 2by4_alt_case2.';
  pariomino_lp_write ( filename, label, m, n, a, b );

  fprintf ( 1, '\n' );
  fprintf ( 1, '  LPmake_2by4_alt_case2 created the LP file "%s"\n', filename );
