function [p_shapes, r_shape, p_num, d, m, n, f] = LPmake_pariominoes_Figure8 ()

%*****************************************************************************80
%
%% LPmake_pariominoes_Figure8 () creates the LP file for Figure 8 in the reference below.
%
%  Discussion:
%
...
%    techniques are applied (cf. LPmake_polyominoes_Figure8). 
%    
%
%  Licensing:
%
...
%
  filename ='Figure8_pariominoes.lp';
  label = '\ LP file for Figure8 in the pariomino paper (colouring techniques used).';
  pariomino_lp_write ( filename, label, m, n, a, b );
  
  fprintf ( 1, '\n' );
  fprintf ( 1, '  LPmake_pariominoes_Figure8 created the LP file "%s"\n', filename );
